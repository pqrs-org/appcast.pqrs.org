...
sh scripts/markdown-to-html.sh update-descriptions/tinkle.md >>"$targetdir/tinkle-appcast-devel.xml.tmp"
...
<p>
  <a href="https://tinkle.pqrs.org/docs/releasenotes/">More</a>
      ...
      <enclosure url="https://github.com/pqrs-org/Tinkle/releases/download/$tag/Tinkle-$version.dmg"
                 ...
                 $signature
      />
      <sparkle:fullReleaseNotesLink>https://tinkle.pqrs.org/docs/releasenotes/</sparkle:fullReleaseNotesLink>
    </item>
